			...
			<div class="cnt-account">
				<ul class="list-unstyled">
					...
					<li style="list-style: none; margin: 5px 0;">
						<a href="my-account.php" style="color: #333; text-decoration: none; padding: 2px; display: flex; align-items: center; transition: color 0.3s;">
							<i class="icon fa fa-user" style="margin-right: 8px;"></i>My Account
						</a>
					</li>
					<li style="list-style: none; margin: 5px 0;">
						<a href="my-wishlist.php" style="color: #333; text-decoration: none; padding: 2px; display: flex; align-items: center; transition: color 0.3s;">
							<i class="icon fa fa-user" style="margin-right: 8px;"></i>Wishlist
						</a>
					</li>

					<li style="list-style: none; margin: 5px 0;">
						<a href="my-cart.php" style="color: #333; text-decoration: none; padding: 2px; display: flex; align-items: center; transition: color 0.3s;">
							<i class="icon fa fa-shopping-cart" style="margin-right: 8px;"></i>My Cart
						</a>
					</li>
					<li style="list-style: none; margin: 5px 0;">
						<a href="messages.php" style="color: #333; text-decoration: none; padding: 2px; display: flex; align-items: center; transition: color 0.3s;">
							<i class="icon fa fa-envelope" style="margin-right: 8px;"></i>Messages
						</a>
					</li>
					<?php if (strlen($_SESSION['login']) == 0) {   ?>
						<li style="list-style: none; margin: 5px 0;">
							<a href="login.php" style="color: #333; text-decoration: none; padding: 2px; display: flex; align-items: center; transition: color 0.3s;">
